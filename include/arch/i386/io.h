...
/*
 * Note: this is directly copied from arch/armv7a/io.h.
 *
 * Maybe we should put this into arch/generic.
 */
 ...
 *
 * x86 note: before turning on MMU we are under a simple identity mapping.
 */
