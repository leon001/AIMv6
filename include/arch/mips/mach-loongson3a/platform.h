...
#define LOONGSON3A_CPU_WINx_BASEADDR(x)	(LOONGSON3A_CPU_WIN_BASE + (x) * 8)
#define LOONGSON3A_CPU_WINx_MASKADDR(x)	(LOONGSON3A_CPU_WINx_BASEADDR(x) + 0x40)
#define LOONGSON3A_CPU_WINx_MMAPADDR(x)	(LOONGSON3A_CPU_WINx_BASEADDR(x) + 0x80)
#define LOONGSON3A_COREx_WINy_BASEADDR(x, y) \
	(LOONGSON3A_CORE_WIN_BASE + (x) * 0x100 + (y) * 0x8)
#define LOONGSON3A_COREx_WINy_MASKADDR(x, y) \
	(LOONGSON3A_COREx_WINy_BASEADDR(x, y) + 0x40)
#define LOONGSON3A_COREx_WINy_MMAPADDR(x, y) \
	(LOONGSON3A_COREx_WINy_BASEADDR(x, y) + 0x80)
#define LOONGSON3A_COREx_WINy_BASE(x, y) \
	read64(LOONGSON3A_COREx_WINy_BASEADDR(x, y))
#define LOONGSON3A_COREx_WINy_MASK(x, y) \
	read64(LOONGSON3A_COREx_WINy_MASKADDR(x, y))
#define LOONGSON3A_COREx_WINy_MMAP(x, y) \
	read64(LOONGSON3A_COREx_WINy_MMAPADDR(x, y))
